...
municipalites = data[data['Type'] == 'MÉ']
...
municipalites['PctAcc'] = 100 * (municipalites['Pop21'] - municipalites['Pop16']) / municipalites['Pop16']
...
plt.title('Pourcentage d\'accroissement de la population en fonction de la population en 2021')
plt.show()
...
municipalites['Population_Category'] = pd.cut(municipalites['Pop21'], bins=bins, labels=labels)
